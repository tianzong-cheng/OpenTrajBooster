...
# 定义相机视角映射
VIEW_MAPPING = {0: "ego_view", 1: "wrist_left", 2: "wrist_right"}  # 头部相机  # 左手腕相机  # 右手腕相机
...
def main():
    ...
    create_metadata_files(
        episode_data, output_dir, args.dataset_name, args.robot_type, args.fps, image_shapes, code_type=args.video_enc
    )
